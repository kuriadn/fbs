...
op.create_table(
    ...
    # ============================================================================
    # DMS TABLES (Document Management System)
    # ============================================================================
    ...
    op.create_table(
        ...
        sa.Column('solution_name', sa.String(length=100), nullable=False),
        sa.Column('confidentiality_level', sa.String(length=20), nullable=False),
        sa.Column('description', sa.Text(), nullable=True),
        sa.Column('metadata', sa.JSON(), nullable=False),
...
# DMS indexes
op.create_index('idx_dms_document_types_name', 'dms_document_types', ['name'], unique=False)
op.create_index('idx_dms_document_categories_name', 'dms_document_categories', ['name'], unique=False)
op.create_index('idx_dms_document_tags_name', 'dms_document_tags', ['name'], unique=False)
op.create_index('idx_dms_documents_solution_name', 'dms_documents', ['solution_name'], unique=False)
op.create_index('idx_dms_documents_state', 'dms_documents', ['state'], unique=False)
op.create_index('idx_dms_documents_created_by', 'dms_documents', ['created_by'], unique=False)
op.create_index('idx_dms_file_attachments_solution_name', 'dms_file_attachments', ['solution_name'], unique=False)
...
def downgrade():
    ...
    # DMS indexes
    op.drop_index('idx_dms_file_attachments_solution_name')
    ...
    # DMS tables
    op.drop_table('dms_document_tags_association')
